...
static void aperiodic_task()
{
	...
	printf("Aperiodic task done. Response time = %d!\n", aperiodicCounter);
	fflush(stdout);
...
int main(void)
{
	...
	myTimer = xTimerCreate((signed char *)"Timer", pdMS_TO_TICKS(5000), pdTRUE, (void *)0, vTimerCallback);
